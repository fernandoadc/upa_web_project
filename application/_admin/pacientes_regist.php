        ...
        <section class="col-lg-7 connectedSortable">
          <div class="box box-default">
            ...
            <div class="box-footer clearfix no-border">
              <button type="button" class="btn btn-success pull-right" onclick="paciente()"><i class="fa fa-plus"></i> Add paciente</button>
            </div>
            <script>function paciente(){location.href="paciente.php"}</script>
          </div>
        </section>
      </div>
    </section>
