...
<div class="register-box">
  ...
  <div class="register-box-body">
    ...
    <form action="valUsuario.php" method="post">
      ...
      <div class="form-group has-feedback">
        <input type="password" name="senhac" class="form-control" placeholder="Confirmar senha">
        <!--<span class="glyphicon glyphicon-lock form-control-feedback"></span>-->
      </div>
      <div class="form-group has-feedback">
        <input type="tel" name="contato" class="form-control" placeholder="Telefone">
